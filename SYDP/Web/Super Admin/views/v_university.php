            ...
            <div class="row">
             ...
             <!-- begin panel -->
                    ...
                    <div class="panel-body">
                        <br>
                        <form id="AddForm" method="POST" action="../functionalities/insert.php">
                            <div class="row row-space-10">      

                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Institute / University :</label>
                                        <input type="text" name="univ_name" id="univ_name" class="form-control m-b-5" placeholder="Enter Institute / University" required/>
                                    </div>
                                </div>

                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label>Institute / University Descriptions:</label>
                                        <input type="text" name="univ_description" id="univ_description"class="form-control m-b-5" placeholder="Enter Institute / University Descriptions" required/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row row-space-10"> 
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label>Institute / University Address:</label>
                                        <input type="text" name="univ_location" id="univ_location"class="form-control m-b-5" placeholder="Enter Institute / University Address" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Type:</label>
                                        <select id="univ_type" name="univ_type" class="form-control form-control m-b-5" data-parsley-required="true">
                            ...
                            <div class="modal-footer">
                                <button type="submit" onclick="sweetalertclick()" name="add_school" class="btn btn-primary">Save</button>
                        ...
                        <div class="panel-body">
                            <table id="data-table-select" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `r_university` where univ_status = 'Active' ");
                                    ...
                                    <tr>
                                        ...
                                        <td width=""><span class="label label-primary"><?php echo $univ_status; ?><span></td>
