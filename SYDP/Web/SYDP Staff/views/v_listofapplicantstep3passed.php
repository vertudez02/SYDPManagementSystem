                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                         ...
                                         <a data-toggle="modal" href="#edit<?php echo $app_step3_id?>" class="btn btn-primary">
                                                            <i class="fa fa-eye" data-size="16" title="Modify Details"></i>
                       ...
                       <div class="row row-space-10">      
                        ...
                        <div class="row row-space-10">    
                            ...
                            <div class="row row-space-10"> 
                                ...
                                <div class="modal-footer">
                                <button type="submit" name="textinterviewpass" onclick="sweetalertclick1()" class="btn btn-primary">Save</button>
