...
?>
        ...
        <div id="content" class="content">
            ...
            <!-- begin page-header -->
            <h1 class="page-header">List of Stipen Claimed</h1>
            <!-- end page-header -->
                            ...
                            <table id="data-table-select" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width=""><?php echo $stipen_scheduledate; ?></td>
                                        <td width=""><?php echo $semester_description; ?></td>
                                        <td width=""><span class="label label-primary"><?php echo $stipen_status; ?><span></td>
                        ...
                        <div class="row row-space-10"> 
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="renewal_status" name="renewal_status" class="form-control form-control m-b-5" data-parsley-required="true"/>
                                ...
                                <button type="submit" name="forrenew" onclick="sweetalertclick1()" class="btn btn-primary">Save</button>
