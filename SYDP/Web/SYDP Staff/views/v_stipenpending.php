...
?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">List of Stipen Pending</h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
                        ...
                        <div class="panel-heading" style="background-color:rgb(16,53,130);">
                           ...
                           <h4 class="panel-title">List of Student for Stipen</h4>
                        </div>
                        <!-- end panel-heading -->
                        ...
                        <div class="panel-body">
                            <table id="data-table-select" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>   
                                    <tr>
                                        <td hidden><?php echo $stipen_id; ?></td>
                                        ...
                                        <td width=""><span class="label label-warning"><?php echo $stipen_status; ?><span></td>
                                       <td class="text-nowrap">

                                         <a data-toggle="modal" href="#edit<?php echo $stipen_id?>" class="btn btn-warning">
            ...
            <div class="modal-dialog">
             <div class="modal-content">
                      ...
                      <div class="modal-header">
                        <h4 class="modal-title">Stipen for Approval</h4>
                     ...
                     <div class="modal-body">
                        ...
                        <div class="row row-space-10"> 
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Set Date Claim:</label>
                                        <input type="date" name="stipen_scheduledate" id="stipen_scheduledate" class="form-control m-b-5" placeholder="" required/>
                                    </div>
                                </div>
                                ...
                                <button type="submit" name="forrelease" onclick="sweetalertclick1()" class="btn btn-primary">Save</button>
