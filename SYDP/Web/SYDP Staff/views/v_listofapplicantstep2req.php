...
?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">List of Applicant Requirements</h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
                        ...
                        <div class="panel-heading" style="background-color:rgb(16,53,130);">
                           ...
                           <h4 class="panel-title">Applicant Requirements</h4>
                        </div>
                        <!-- end panel-heading -->
                        ...
                        <div class="panel-body">
                            <table id="data-table-select" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `t_step2_appreq` p INNER JOIN `t_application_student_profile` a ON a.app_profile_no=p.app_profile_no where app_step2_status = 'Completed'");
